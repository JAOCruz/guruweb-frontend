...
export const LAWS: LawLink[] = [
  {
    id: 'dgii-valores-fidedignos',
    institution: 'DGII – Valores Fidedignos de Vehículos',
    category: 'Tránsito y Vehículos',
    description: 'Consulta oficial de valores fidedignos de vehículos motorizados ante la DGII.',
    url: 'https://dgii.gov.do/vehiculosMotor/consultas/Paginas/Valores-Fidedignos.aspx',
    relatedDocCategories: ['CONTRATOS CIVILES'],
  },
  {
    id: 'pn-s99',
    institution: 'Policía Nacional – Creación S99',
    category: 'Seguridad Ciudadana',
    description: 'Sistema de la Policía Nacional para creación de constancias y documentos S99.',
    url: 'https://servicios.pn.gob.do/wfp/create/S99',
