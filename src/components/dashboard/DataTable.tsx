          ...
          <table className="min-w-full table-fixed divide-y divide-gray-800 text-base">
            ...
            <tbody className="divide-y divide-gray-800/50 bg-gray-900/40">
              ...
              <tr className="bg-gray-900/80">
                <td
                  className="metallic-3d-text w-[40%] px-6 py-4 text-base font-bold tracking-[0.2em] whitespace-nowrap"
                  colSpan={3}
                >
                  TOTAL
                </td>
                <td className="metallic-3d-text w-[20%] px-6 py-4 text-base font-bold tracking-[0.2em] whitespace-nowrap text-blue-200">
                  {total.toFixed(2)}
                </td>
              </tr>
              ...
              <tr className="bg-gray-900/50">
                <td
                  className="w-[40%] px-6 py-4 text-base whitespace-nowrap text-gray-300"
                  colSpan={3}
                >
                  {displayName} (50%)
                </td>
                <td className="neon-text w-[20%] px-6 py-4 text-base font-semibold whitespace-nowrap text-yellow-400">
                  {userShare.toFixed(2)}
                </td>
              </tr>
            </tbody>
